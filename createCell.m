function [ data ] = createCell( fileName )
%must include this file to get rid of abnormal matlab behaviour while
%reading files(double[] and byte[])

fid = fopen(fileName); % load each line as a single string
